...
public class GridTravelerMemoization {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("1x1 = " + gridTraveler(1, 1, new WeakHashMap<>()));
        System.out.println("2x3 = " + gridTraveler(2, 3, new WeakHashMap<>()));
        System.out.println("3x2 = " + gridTraveler(3, 2, new WeakHashMap<>()));
        System.out.println("3x3 = " + gridTraveler(3, 3, new WeakHashMap<>()));
        System.out.println("18x18 = " + gridTraveler(18, 18, new WeakHashMap<>()));
/*
        ...
        System.out.print("Y = ");
        int y= s.nextInt();
        System.out.print("Number of ways can we travel to the goal on a grid with dimensions "+x+"x"+y+" = "+gridTraveler(x, y, new WeakHashMap<>()));
*/
    }
}